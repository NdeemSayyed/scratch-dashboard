	...
	return (
		<ConfiguratorRoot variant="permanent" ownerState={{ openConfigurator }}>
			<MDBox
				...
				px={3}>
				<MDBox>
					<MDTypography variant="h5">Admin panel Configurator</MDTypography>
			...
			<MDBox pt={0.5} pb={3} px={3}>
				...
				<MDBox mt={2} textAlign="center">
					<MDBox mb={0.5}>
						<MDTypography variant="h6">Follow us here!</MDTypography>
					</MDBox>
					...
					<MDBox display="flex" justifyContent="center">
						<MDBox mr={1.5}>
							<MDButton
								component={Link}
								href="https://twitter.com/danerobnft?lang=en"
								target="_blank"
								rel="noreferrer"
								color="dark">
								<TwitterIcon />
